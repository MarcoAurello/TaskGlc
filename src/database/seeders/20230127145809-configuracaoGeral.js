          ...
          <tr>
            <td class="wrapper">
              <table border="0" cellpadding="0" cellspacing="16">
                <img
                  src="http://intranet.pe.senac.br/dr/logo/senac_logo.png"
                />
              </table>
              <table
                border="0"
            ...
            <tr>
              <td class="content-block">
                <span class="apple-link"
                  ><a href="http://www.pe.senac.br">SENAC Pernambuco</a>,
                  Av. Visconde de Suassuna, 500 - Santo Amaro - Recife</span
                >
              </td>
            </tr>
            <tr>
...
`,
      urlAd: 'ldap://10.9.8.16',
      baseDN: 'drpe',
      usernameAd: 'diegoalisson@pe.senac.br',
      passwordAd: 'gti@2021',
      createdAt: new Date(),
      updatedAt: new Date()
    }], {})
  ...
  async down (queryInterface, Sequelize) {
     ...
     */
    await queryInterface.bulkDelete('configuracaoGeral', null, {})
  }
}
