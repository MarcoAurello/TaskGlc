  ...
  async up (queryInterface, Sequelize) {
    ...
    */
    await queryInterface.bulkInsert('classificacao', [
      ...
      { id: uuid(), nome: 'Circunstancial', descricao: 'Tarfas desnecessárias feitas por comodidade ou por serem socialmente apropriadas.', createdAt: new Date(), updatedAt: new Date() },
      ...
      { id: uuid(), nome: 'Execução Imediata', descricao: 'Atividades onde o tempo está curto ou acabou.', createdAt: new Date(), updatedAt: new Date() },
