...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    */
    ...
    {
      id: uuid(),
      nome: 'ESPECIFICAÇÕES TÉCNICAS EQUIPAMENTOS / PROJETOS',
      fkArea: ProcessosDep[0][0].id,
      createdAt: new Date(),
      updatedAt: new Date()
    ...
    {
      id: uuid(),
      nome: 'ESPECIFICAÇÕES TÉCNICAS MOBILIÁRIOS / PROJETOS',
      fkArea: ProcessosDep[0][0].id,
      createdAt: new Date(),
      updatedAt: new Date()
    ...
    {
      id: uuid(),
      nome: 'ESPECIFICAÇÕES TÉCNICAS MATERIAIS / PROJETOS',
      fkArea: ProcessosDep[0][0].id,
      createdAt: new Date(),
      updatedAt: new Date()
    ...
    {
      id: uuid(),
      nome: 'CONTRATAÇÃO POR DISPENSA / INEXIGIBILIDADE',
      fkArea: ProcessosDep[0][0].id,
      createdAt: new Date(),
      updatedAt: new Date()
